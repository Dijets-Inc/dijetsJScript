...
export class EVMAPI extends JRPCAPI {
  ...
  export = async (
    ...
    return this.callMethod('djtx.export', params).then((response: RequestResponseData) => response.data.result.txID);
  };
  ...
  exportDJTX = async (
    ...
    return this.callMethod('djtx.exportDJTX', params).then((response: RequestResponseData) => response.data.result.txID);
  };
  ...
  getUTXOs = async (
    ...
    return this.callMethod('djtx.getUTXOs', params).then((response: RequestResponseData) => {
  ...
  importKey = async (
    ...
    return this.callMethod('djtx.importKey', params).then((response: RequestResponseData) => response.data.result.address);
  };
  ...
  issueTx = async (tx: string | Buffer | Tx): Promise<string> => {
    ...
    return this.callMethod('djtx.issueTx', params).then((response: RequestResponseData) => response.data.result.txID);
  };
  ...
  exportKey = async (
    ...
    return this.callMethod('djtx.exportKey', params).then((response: RequestResponseData) => response.data.result.privateKey);
  };
  ...
  buildExportTx = async (
    ...
    if(bintools.cb58Encode(assetDescription.assetID) === assetID) {
      ...
      const evmDJTXInput: EVMInput = new EVMInput(fromAddressHex, fee, assetDescription.assetID, nonce);
   ...
   */
  constructor(core: DijetsCore, baseurl: string = '/ext/bc/C/djtx', blockchainID: string = '') { 
    super(core, baseurl); 
    this.blockchainID = blockchainID;
