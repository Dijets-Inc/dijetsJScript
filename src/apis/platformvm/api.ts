...
export class PlatformVMAPI extends JRPCAPI {
   ...
   */
  exportDJTX = async (username: string, password:string, amount:BN, to:string,):Promise<string> => {
    const params:any = {
      username,
      password,
      to,
   ...
   * by calling issueTx.
   */
  importDJTX = async (username: string, password:string, to:string, sourceChain:string)
  :Promise<string> => {
    const params:any = {
      to,
      sourceChain,
 ...
 */
  ...
  */
   ...
   */
  constructor(core:DijetsCore, baseurl:string = '/ext/bc/P') { 
    super(core, baseurl); 
