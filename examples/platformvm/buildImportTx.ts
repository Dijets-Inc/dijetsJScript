...
const pchain: PlatformVMAPI = dijets.PChain()
...
const memo: Buffer = Buffer.from("PlatformVM utility method buildImportTx to import DJTX to the P-Chain from the X-Chain")
