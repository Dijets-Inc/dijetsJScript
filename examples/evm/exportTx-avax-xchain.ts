...
const main = async (): Promise<any> => {
  ...
  const evmInput: EVMInput = new EVMInput(cHexAddress, balance, djtxAssetIDStr, nonce)
  ...
  const transferableOutput: TransferableOutput = new TransferableOutput(djtxAssetIDBuf, secpTransferOutput)
