...
const main = async (): Promise<any> => {
  ...
  let evmInput: EVMInput = new EVMInput(cHexAddress, djtxBalance, djtxAssetIDStr, nonce)
  ...
  let secpTransferOutput: SECPTransferOutput = new SECPTransferOutput(djtxBalance.sub(fee), xAddresses, locktime, threshold)
  let transferableOutput: TransferableOutput = new TransferableOutput(djtxAssetIDBuf, secpTransferOutput)
